            ...
            <Container>
                ...
                <View style={{ top: height * 0.3, marginTop: 25 }}>
                    <Text style={[styles.TextStyle, { alignSelf: 'center', fontSize: 20, color: '#717171' }]}>
                        {(this.state.page == 'Volunteer'&& this.state.vType==2 )? strings.WaitForApproval + ' .' : (this.state.page == 'NeedHelp'||(this.state.page == 'Volunteer'&& this.state.vType!=2 )) ? strings.YourRequestHasBeenSent + ' ،' : strings.YourMessageHasBeenSent + '   '}
                    </Text>
